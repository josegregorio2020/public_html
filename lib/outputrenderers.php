...
public function edit_switch() {
    ...
    // Verifica si el usuario tiene permiso para actualizar el curso (es decir, no es estudiante).
    if (!has_capability('moodle/course:update', $this->page->context, $USER)) {
        return ''; // No mostrar nada si no tiene capacidad.
    }
